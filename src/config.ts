...
export interface AppConfig {
  ...
  /** Default country for searches (when no address is configured) */
  defaultCountry?: string;
  /** Cached last search results for `buy <number>` */
  lastSearchResults?: SearchResultCache[];
}
...
/**
 * Reset all agents back to default (used on logout).
 */
